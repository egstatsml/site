...
The leapfrog steps in \textbf{Eqns. 29-31} should read,
\begin{align*}
  v_i(t + \frac{\epsilon}{2}) = v_i(t) + \frac{\epsilon}{2} \dfrac{\partial U}{\partial w_{i}}(v(t)),
  \\
  w_i(t + \epsilon) = w_i(t) + \epsilon \frac{v_{i}(t + \epsilon /2)}{m_{i}},
  \\
  v_i(t + \epsilon) = v_i(t +\frac{\epsilon}{2}) - \frac{\epsilon}{2} \dfrac{\partial U}{\partial w_{i}}(v(t + \epsilon)).
\end{align*}
